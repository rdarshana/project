                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="category_listing">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <ul>
                                                    <li style="list-style-type: none;"><h3><a href="<?php echo base_url("index.php/homeControll/MusicLoadById/MusicGroup/$object->id")?>"><?php echo $object->group_name ?></a></h3></li>                                       
