                            ...
                            <table id="data" class="table table-striped table-bordered table-responsive table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">No of group Members</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($allDetails as $details) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $details->group_name; ?></td>
                                            ...
                                            <td class="text-center"><?php echo $details->number_of_members; ?></td>
                                            <td class="text-right"><?php echo number_format($details->charges, 2, '.', ''); ?></td>
                                            <td class="text-center">
                                                <a href="<?php echo site_url()."/MusicGroupRegistrationController/editMusicGroup/".$details->id ?>">
                                                    <i class='glyphicon glyphicon-edit'></i>
                                                </a> | 
                                                <a href="<?php echo site_url()."/MusicGroupRegistrationController/viewMusicGroupDetails/".$details->id ?>" >
            ...
            <script>
                                                    ...
                                                    function deleteGroup(id) {
                                                        ...
                                                        alertify.confirm("Warning", "Are you sure, you want to Remove This Group ?",
                                                                function () {
                                                                    $.post("<?php echo site_url()."/MusicGroupRegistrationController/deleteGroup/" ?>" + id)
                                                                            .done(function (data) {
                                                                                if (data == "success") {
