...
<html lang="en">
    ...
    <head>
        ...
        <title>Add Music Group</title>

        <!-- Bootstrap Core CSS -->
        <link href="<?php echo base_url();?>css/bootstrap.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="<?php echo base_url();?>css/business-frontpage_music.css" rel="stylesheet">
    ...
    <body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Music Group Registration</a>
                </div>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active">
                            <a href="<?php echo site_url()."/MusicGroupRegistrationController" ?>">Add Group</a>
                        </li>
                        <li >
                            <a href="<?php echo site_url()."/MusicGroupRegistrationController/loadImagesAddView" ?>">Add Photos</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url()."/MusicGroupRegistrationController/viewMusicGroup" ?>">Manage group</a>
                        </li>
                ...
                <div class="col-sm-8 well">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="dancing_group_form">
                        ...
                        <fieldset>
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textinput">Group Name</label>  
                                <div class="col-md-7">
                                    <input name="group_name" id="group_name" type="text" placeholder="" value="<?php
                                    if (isset($id)) {
                                        echo $group_name;
                                    }
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textinput">No of group Members</label>  
                                <div class="col-md-7">
                                    <input id="members" name="members" type="text" placeholder="" value="<?php
                                           if (isset($id)) {
                            ...
                            <!-- Textarea -->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textarea">Music Styles</label>
                                <div class="col-md-7">                     
                                    <textarea class="form-control" id="music_style" name="music_style" required><?php
                                           if (isset($id)) {
                                               echo $music_styles;
                                           }
                                           ?></textarea>
                            ...
                            <!-- Textarea -->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textarea">Group Details</label>
                                <div class="col-md-7">                     
                                    <textarea class="form-control" id="group_details" name="group_details" required><?php
                                    if (isset($id)) {
                                        echo $group_details;
                                    }
                                           ?></textarea>
        ...
        <script>
            $("#dancing_group_form").attr("action", "<?php echo site_url()."/MusicGroupRegistrationController/createMusicGroup" ?>");
                ...
                $("#dancing_group_form").ajaxForm({
                    ...
                    success: function (data) {
                        ...
                        if (msg1 != "-1") {
                            ...
                            setTimeout(function () {
                                window.location.href = "<?php echo site_url()."/MusicGroupRegistrationController/viewMusicGroup" ?>";
                            }, 1000);
                        } else if (msg2 != "-1") {
