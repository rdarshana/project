                                    ...
                                    foreach ($allDetails as $details) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url()."/LightsRegistrationController/editLightGroup/".$details->id ?>">
                                                    <i class='glyphicon glyphicon-edit'></i>
                                                </a> | 
                                                <a href="<?php echo site_url()."/LightsRegistrationController/viewLightGroupDetails/".$details->id ?>" >
            ...
            <script>
                                                    ...
                                                    function deleteGroup(id) {
                                                        ...
                                                        alertify.confirm("Warning", "Are you sure, you want to Remove This Group ?",
                                                                function () {
                                                                    $.post("<?php echo site_url()."/LightsRegistrationController/deleteGroup/" ?>" + id)
                                                                            .done(function (data) {
                                                                                if (data == "success") {
