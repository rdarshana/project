...
<html lang="en">
    ...
    <body>
                ...
                <div class="col-sm-8 well">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="photo_form">
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>Add Light Supplier Images</legend>

                            <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textinput">Light Supplier</label>  
                                <div class="col-md-7">
        ...
        <script>
            $("#photo_form").attr("action", "<?php echo site_url()."/LightsRegistrationController/uploadImages" ?>");
