...
<html lang="en">
    ...
    <head>
        ...
        <title>Add Other Supplier</title>
    ...
    <body>
        ...
        <script>
            $("#dancing_group_form").attr("action", "<?php echo site_url()."/OtherRegistrationController/createOtherGroup" ?>");
                ...
                $("#dancing_group_form").ajaxForm({
                    ...
                    success: function (data) {
                        ...
                        if (msg1 != "-1") {
                            ...
                            setTimeout(function () {
                                window.location.href = "<?php echo site_url()."/OtherRegistrationController/viewOtherGroup" ?>";
                            }, 1000);
                        } else if (msg2 != "-1") {
