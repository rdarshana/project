...
<html lang="en">
    ...
    <head>
        ...
        <title>Add Sound Supplier</title>
    ...
    <body>
                ...
                <div class="col-sm-8 well">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="dancing_group_form">
                        ...
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>Add Sound Supplier</legend>
        ...
        <script>
            $("#dancing_group_form").attr("action", "<?php echo site_url()."/SoundsRegistrationController/createSoundGroup" ?>");
                ...
                $("#dancing_group_form").ajaxForm({
                    ...
                    success: function (data) {
                        ...
                        if (msg1 != "-1") {
                            ...
                            setTimeout(function () {
                                window.location.href = "<?php echo site_url()."/SoundsRegistrationController/viewSoundGroup" ?>";
                            }, 1000);
                        } else if (msg2 != "-1") {
