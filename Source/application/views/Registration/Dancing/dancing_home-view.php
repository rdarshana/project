...
<html lang="en">
    ...
    <body>
                ...
                <div class="col-sm-8 well">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" id="dancing_group_form">
                        ...
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>Add Dancing Group</legend>
                            ...
                            <!-- Textarea -->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="textarea">Dancing Styles</label>
                                <div class="col-md-7">                     
                                    <textarea class="form-control" id="dancing_style" name="dancing_style" required><?php
                                           if (isset($id)) {
                                               echo $dancing_styles;
                                           }
                                           ?></textarea>
        ...
        <script>
            $("#dancing_group_form").attr("action", "<?php echo site_url()."/DancingGroupRegistrationController/createDancingGroup" ?>");
                ...
                $("#dancing_group_form").ajaxForm({
                    ...
                    success: function (data) {
                        ...
                        if (msg1 != "-1") {
                            ...
                            setTimeout(function () {
                                window.location.href = "<?php echo site_url()."/DancingGroupRegistrationController/viewDancingGroup" ?>";
                            }, 1000);
                        } else if (msg2 != "-1") {
