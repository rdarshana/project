                                    ...
                                    foreach ($allDetails as $details) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo site_url()."/DancingGroupRegistrationController/editDancingGroup/".$details->id ?>">
                                                    <i class='glyphicon glyphicon-edit'></i>
                                                </a> | 
                                                <a href="<?php echo site_url()."/DancingGroupRegistrationController/viewDancingGroupDetails/".$details->id ?>" >
            ...
            <script>
                                                    ...
                                                    function deleteGroup(id) {
                                                        ...
                                                        alertify.confirm("Warning", "Are you sure, you want to Remove This Group ?",
                                                                function () {
                                                                    $.post("<?php echo site_url()."/DancingGroupRegistrationController/deleteGroup/" ?>" + id)
                                                                            .done(function (data) {
                                                                                if (data == "success") {
